...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Soldis — Premium självbruna produkter" },
      { name: "description", content: "Naturlig solbränna utan sol. Mousse, droppar och spray av högsta kvalitet — fri frakt över 399 kr." },
      { property: "og:title", content: "Soldis — Premium självbruna produkter" },
      { property: "og:description", content: "Naturlig solbränna utan sol. Mousse, droppar och spray av högsta kvalitet." },
